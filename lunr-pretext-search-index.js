...
},
{
  ...
  "number": "1.14.2",
  "title": "Change of basis matrix.",
  "body": " Change of basis matrix   Let and be two ordered bases of the finite-dimensional vector space .    .    For all we have In other words, to convert the -coordinates of a vector to -coordinates, simply multiply on the left by the matrix .    The matrix is the unique matrix satisfying : i.e., if for all , then .          Let . From formula applied to , we see that the -th column of is for all . Using formula from this is precisely the -th column of for all . We conclude that .    This follows from (1) and : .    By (2) of (the uniqueness claim), if satisfies for all , then . Since , we conclude .      "
},
{
...
{
  "id": "ss_change_basis_matrix-5",
  "level": "2",
  "url": "s_change_basis.html#ss_change_basis_matrix-5",
  "type": "Example",
  "number": "1.14.4",
