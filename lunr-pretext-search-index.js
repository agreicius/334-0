...
},
{
  ...
  "body": " Linear combination of a tuple   Let be an -vector space, and let be a tuple of elements of . A linear combination of the vectors is an expression of the form , where for all , and for all but finitely many .  Given a linear combination , letting be the finitely many nonzero coefficients, we define .   "
},
{
  "id": "ss_span-4",
  "level": "2",
...
},
{
  ...
  "number": "1.6.3",
  "title": "Span.",
  "body": " Span   Let be an -vector space, and let be a tuple of vectors of , where is a nonempty set. The span of , denoted , is defined as follows.   If , so that is the empty tuple (or empty list), then we define .    Otherwise we define as the set of all linear combinations of : , .      "
},
{
