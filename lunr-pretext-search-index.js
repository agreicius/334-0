...
},
{
  ...
  "body": " Minimal polynomial from Jordan form   Let , where is finite dimensional, and suppose the characteristic polynomial of factors as , where for , and . Let be the minimal polynomial of . We have , where is the maximum size of a -Jordan block appearing in a Jordan form for .       "
},
{
  "id": "th_similarity",
  "level": "2",
...
},
{
  ...
  "body": " Square-roots of complex matrices   Let be an invertible matrix. There is a matrix such that . In other words, every invertible complex matrix has a square root.       "
},
{
  "id": "eg_jordan_form_1",
  "level": "2",
