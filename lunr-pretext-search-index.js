...
},
{
  ...
  "body": " Space of linear transformations   Let and be vector spaces. Below we define a vector space structure on .   Vector operations  Given linear transformations and scalar , we define linear transformations as follows: .    Zero vector  The zero vector of is the zero transformation defined for all .    Vector inverses  Given a linear transformation , its vector inverse is the linear transformation defined as for all .   We call , together with these vector operations, the space of linear transformations from to .   "
},
{
