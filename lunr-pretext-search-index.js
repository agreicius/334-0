...
{
  "id": "ss_tuples_cart_prod-4",
  "level": "2",
  "url": "s_sets_functions.html#ss_tuples_cart_prod-4",
  "type": "Remark",
  "number": "0.1.25",
...
},
{
  ...
  "body": " Space of infinite sequences   Let be a field. Recall that is the set of all -valued infinite sequences: , . Below we define a vector space structure on .   Vector operations  Given and , we define .    Zero vector  The zero vector of with respect to these operations is .    Vector inverses  Given a sequence , its vector inverse is .      "
},
{
  "id": "d_matrix_space",
  "level": "2",
...
},
{
  ...
  "body": " Real-valued functions   Let be an interval in the real lines. Using the function interpretation is the set of all functions of the form . The vector operations defined in in this setting correspond to the function-arithmetic operations you met in precalculus and calculus: , given functions , their vector sum is the function defined as for all . Similarly, given a scalar and function , the vector scalar multiple is the function defined as for all .       "
},
{
