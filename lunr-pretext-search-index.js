...
},
{
  ...
  "number": "0.1.24",
  "title": "I-tuple.",
  "body": " I-tuple  tuple arbitrary    -tuple    Let and be sets. An -tuple with entries (or coordinates) in is a function . We call the indexing set of the tuple , and for all , we call the -th entry (or coordinate ) of . Furthermore, we will write to denote the tuple whose -th entry is for all .   "
},
{
...
{
  "id": "ss_tuples_cart_prod-10",
  "level": "2",
  "url": "s_sets_functions.html#ss_tuples_cart_prod-10",
  "type": "Remark",
  "number": "0.1.30",
