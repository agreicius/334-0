...
{
  "id": "cor_direct_sum_existence",
  "level": "2",
  "url": "s_dimention.html#cor_direct_sum_existence",
  "type": "Corollary",
  "number": "1.8.13",
  "title": "Existence of direct sums.",
  "body": " Existence of direct sums   Assume is a finite-dimensional vector space. Given any subspace there is a subpace satisfying .    Assume . Given a subspace , we know that , and hence that has a finite basis for some . Since is linearly independent, it can be extended to a basis of . Define . We claim that .   "
},
{
  ...
  "body": " Dimension theory compendium   Let be a vector space of dimension , and let be a tuple of vectors of .   Contract  If spans , then can be contracted to a basis of .    Expand  If is linearly independent, then can be extended to a basis of .    Street smarts  If , then does not span .    Street smarts  If , then is linearly dependent.    Street smarts  If , then is a basis if and only if spans if and only if is linearly independent.    Dimension of subspaces  If is a subspace, then    , and     if and only if .       Existence of direct sums  Given any subspace , there is a subspace satisfying .      "
},
{
