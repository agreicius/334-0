...
},
{
  ...
  "body": " stands for field   Henceforth, unless stated otherwise, will always denote a field.   "
},
{
  "id": "d_vector_space",
  "level": "2",
...
},
{
  ...
  "body": " Vector space verification   To decide whether a given set and operations is a vector space, proceed as follows.   Make explicit the underlying set of the proposed vector space.    Make explicit what the scalar multiplication and vector addition operations are.    Identify an element of that serves as the zero vector and indicate the rule that assigns vector inverses to elements of .    Show that the two vector operations and our choice of zero vector and vector inverses satisfy the axioms of .      "
},
{
...
},
{
  ...
  "type": "Definition",
  "number": "1.2.7",
  "title": "Space of <span class=\"process-math\">\\(F\\)<\/span>-valued tuples indexed by <span class=\"process-math\">\\(I\\)<\/span>.",
  "body": " Space of -valued tuples indexed by   Let be a field. Given any set , we define , the set of all functions from to , or equivalently, the set of all -valued tuples indexed by . The following structure makes a vector space.   Vector operations  Given elements and scalar , we define . In other words, is the function defined as for all , and is the function defined as for all .    Zero vector  The zero vector of is the zero function defined as for all . In other words, using tuple notation, we have .    Vector inverse  Given an element its vector inverse is defined as . In other words is the function on defined as for all .      "
},
{
  ...
  "number": "2",
  "title": "",
  "body": " We follow . The definition has taken care of steps (1)-(3) for us, it remains to show that the vector space axioms are satisfied. As you will see, the tuple notation for functions makes these proofs quite straightforward consequences of the field axioms satisfied by .  Consider the arithmetic axioms first. We will verify that Axioms (i), (ii), and (v) are satisfied. Given and , we have . Lastly we will show that does indeed satisfy the additive identity axiom (Axiom (iii)), leaving the verification of Axiom (iv) to the reader. Given any element , we have , as desired.  "
},
{
